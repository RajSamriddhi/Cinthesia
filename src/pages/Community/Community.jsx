...
function Community() {
  ...
  const posts = [
    { author: 'Sneha R.', initial: 'S', time: '2h ago', category: 'Acne', title: 'How do I get rid of hormonal acne?', description: 'I keep getting breakouts around my jawline. Nothing seems to work. Please help! 😢', likes: 24, comments: 12, replies: 12, replyAvatars: ['S','M','A'] },
    { author: 'Mehak S.', initial: 'M', time: '5h ago', category: 'Dryness', title: 'Best moisturizer for dry & flaky skin?', description: 'My skin gets super dry in winters. Need recommendations!', likes: 18, comments: 9, replies: 8, replyAvatars: ['A','R','P'] },
    { author: 'Ananya P.', initial: 'A', time: '1d ago', category: 'Routine Help', title: 'How can I build a simple skincare routine?', description: "I'm a beginner and totally confused. Please help!", likes: 16, comments: 7, replies: 6, replyAvatars: ['S','M','R'] },
    { author: 'Riya T.', initial: 'R', time: '1d ago', category: 'Sensitive Skin', title: 'My skin reacts to almost everything!', description: 'I have sensitive skin and most products irritate me. What ingredients should I avoid?', likes: 21, comments: 11, replies: 9, replyAvatars: ['P','S','A'] },
    { author: 'Pooja M.', initial: 'P', time: '2d ago', category: 'Anti-Aging', title: 'At what age should I start anti-aging?', description: "I'm 23 and want to start early. What should I add to my routine?", likes: 13, comments: 6, replies: 5, replyAvatars: ['M','S','R'] },
  ]
        ...
        <div className="comm-hero__inner container">
          <div className="comm-hero__content">
            ...
            <div className="comm-hero__input-wrap">
              <input type="text" placeholder="What's on your mind?" className="comm-hero__input"/>
              <button className="btn btn-pink">Ask a Question</button>
            </div>
          </div>
